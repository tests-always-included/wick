...
* [Dnsmasq](dnsmasq/README.md) - This adds dnsmasq to your system and makes sure it is prepended as a resolver.
* [Erlang](erlang/README.md) - Installs erlang.
...
* [Lsof](lsof/README.md) - This merely installs the `lsof` command, which may be needed by other programs.
...
* [Netcat](nc/README.md) - Installs `nc`.
...
* [S3cmd](s3cmd/README.md) - This installs a tool to work with Amazon S3.
...
* [Unzip](unzip/README.md) - Simply installs `unzip`.
...
* [Zip](zip/README.md) - Simply installs `zip`.
