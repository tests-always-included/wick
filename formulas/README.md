...
* [Apache2](formulas/apache2/README.md) - Installs the Apache 2.x web server and enables named virtual hosts.  Provides functions to add virtual hosts and config files.
* [At](formulas/at/README.md) - Installs and sets up the `at` package.
* [Cron](formulas/cron/README.md) - Adds useful cron manipulation functions to the Wick environment.
* [Dnsmasq](formulas/dnsmasq/README.md) - This adds dnsmasq to your system and makes sure it is prepended as a resolver.
* [Erlang](formulas/erlang/README.md) - Installs erlang.
* [Hostname](formulas/hostname/README.md) - Sets the hostname and domain.  Supports templates.  Can automatically update the hostname on network connections.
* [Jq](formulas/jq/README.md) - Installs [jq](http://stedolan.github.io/jq/), a command-line tool to process JSON.
* [Kermit](formulas/kermit/README.md) - This installs the Kermit (from the `ckermit` package), allowing file transfer to and from a remote machine.
* [Lsof](formulas/lsof/README.md) - This merely installs the `lsof` command, which may be needed by other programs.
* [Md5deep](formulas/md5deep/README.md) - Sets up md5deep and its related utilities.
* [Mo](formulas/mo/README.md) - This installs the [mo](https://github.com/tests-always-included/mo) command into `/usr/local/bin/` and adds the ability to use "mo" templates with `wickMakeFile` (in the wick-base formula).
* [Netcat](formulas/nc/README.md) - Installs `nc`.
* [NSCD](formulas/nscd/README.md) - This installs a name server caching daemon.  The `unscd` package is preferred over `nscd`, but the two are essentially interchangeable.
* [OpenJDK 1.7 JDK](formulas/openjdk-1.7-jdk/README.md) - Installs OpenJDK 1.7 JDK.
* [OpenJDK 1.7](formulas/openjdk-1.7/README.md) - Installs OpenJDK 1.7 JRE.
* [OpenJDK 1.8 JDK Formula](formulas/openjdk-1.8-jdk/README.md) - Installs OpenJDK 1.8 JDK.
* [OpenJDK 1.8](formulas/openjdk-1.8/README.md) - Installs OpenJDK 1.8 JRE.
* [Redis](formulas/redis/README.md) - Installs redis onto the box.
* [Rvm](formulas/rvm/README.md) - This installs RVM from [http://get.rvm.io/](http://get.rvm.io/).  Passes all extra parameters to the installer.
* [S3cmd](formulas/s3cmd/README.md) - This installs a tool to work with Amazon S3.
* [Sysctl](formulas/sysctl/README.md) - This adds a function to Wick to set a configuration setting.
* [Timezone](formulas/timezone/README.md) - Sets the time zone to a specified zone, defaulting to UTC.
* [Tomcat 7](formulas/tomcat-7/README.md) - Installs Tomcat 7, which depends on Java 1.7 or Java 1.8.
* [Unzip](formulas/unzip/README.md) - Simply installs `unzip`.
* [Wick-Base](formulas/wick-base/README.md) - This formula does not perform any action.  It exists only to add useful functions and explorers to the Wick environment.
* [Wick-Infect](formulas/wick-infect/README.md) - Installs a Bash configuration at `/usr/local/lib/wick-infect` that shell scripts can source into their environment in order to get a copy of all of the [library] functions.
* [Wick-Init-D-Lib](formulas/wick-init-d-lib/README.md) - Not all systems are created equally.  In that regard, not all `/etc/init.d/` environments are the same either.  Instead of rewriting a shell that's extremely similar for multiple services, this formula will install a library that can be used to make init-style scripts quickly.
* [Yum-EPEL](formulas/yum-epel/README.md) - Adds the EPEL repository to yum.  Does not do anything for other package managers.
* [Yum-Remi](formulas/yum-remi/README.md) - Adds the Remi repository for yum.  Will not make it enabled by default.  Does nothing for other platforms that do not use yum.
* [Zip](formulas/zip/README.md) - Simply installs `zip`.
* [ZModem](formulas/zmodem/README.md) - This installs the `lrzsz` package, providing the `rz` and `sz` commands to send/receive files using ZModem.
